...
class CModel {
 public:
  ...
  thrust::device_vector<u32x3> d_MCon;
  thrust::device_vector<u32x3> d_MConEvt;
  thrust::device_vector<int> d_ConPre;
  // 变量->约束
  // thrust::device_vector<thrust::device_vector<u32x3>> d_subcription;
  // thrust::host_vector<thrust::host_vector<u32x3>> h_subcription;
