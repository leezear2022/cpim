...
DEFINE_bool(fqpt_enable_cid_microbatch, false,
            "FQ-PT OW3b: enable cid micro-batch framework path");
DEFINE_int32(fqpt_microbatch_min_sel, 2,
             "FQ-PT OW3b: minimum sel_count for aligned execution");
...
void ConfigureFQPTManager(FQPTBaselineManager& manager) {
    ...
    manager.SetMicrobatchMaxRounds(FLAGS_fqpt_microbatch_max_rounds);
