...
- [OW0 现状与 RTX 4060/4090 策略输入（2026-02）](planning/OW0_RTX4060_4090_STATUS_2026_02.md) - OW0 已落地范围、现有性能证据、PCIe 迁移风险与对外策略任务书
...
- [Metal GAC 长期优化路线](planning/METAL_GAC_LONG_TERM_OPTIMIZATION.md) - Metal v2/v3 GAC 性能优先路线、prepared runner、frontier/算子/内存优化与 recommender gate
